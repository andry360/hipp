...
class MySQL
{
	...
	private $db_host    = "192.168.30.51"; // server name
	private $db_user    = "andreatest";    // user name
	private $db_pass    = "andreatest";    // password
	private $db_dbname  = "andreatest";    // database name
	private $db_charset = "andreatest";    // optional character set (i.e. utf8)
