...
$strsql  = "SELECT * FROM domande WHERE categoria = 'Blocco4' ";
...
?>
<form name="frm" id="frm" action="D4des.php" method="post">
...
<tr><td align="center" colspan="5"><span class="Stile3"><? echo "4/5";?></span></td>
</tr>
<tr class="Stile1">
<td width="68">&nbsp;</td>
<td width="33">&nbsp;</td>
